package com.darren.litesuits.android.log;

import com.darren.loglibs.Constant;
import com.darren.loglibs.utils.FileLogUtils;
import com.darren.loglibs.utils.MyDate;
...
public class LogReader extends Thread {
    ...
    public static final String LOG_FILE_PATH = Constant.LOG;
    public static final String LOG_ROOT_PATH = FileLogUtils.getExternalStoragePath();
    ...
    public void run() {
        ...
        try {
            ...
            String line;
            File file = new File(LOG_ROOT_PATH + File.separator + LOG_FILE_PATH);
            ...
            while ((line = mReader.readLine()) != null) {
                bw.append(MyDate.getDateEN() + " " + packageName + " " + line);
                bw.newLine();
                bw.flush();
            }
        } catch (Exception e) {
